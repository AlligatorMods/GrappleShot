...
namespace Fragsurf.Movement {
    ...
    public class SurfCharacter : MonoBehaviour, ISurfControllable {
        ...
        private void UpdateMoveData () {
            ...
            _moveData.sprinting = Input.GetKey (InputSystem.Sprint);
            
            if (Input.GetKeyDown (InputSystem.Crouch))
                _moveData.crouching = true;

            if (!Input.GetKey(InputSystem.Crouch))
            ...
            bool jump = Input.GetKey (InputSystem.Jump);
            ...
            if (Input.GetKeyDown (InputSystem.Jump))
                _moveData.wishJump = true;

            if (!Input.GetKey(InputSystem.Jump))
